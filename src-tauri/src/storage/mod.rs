//! Local persistence for koe (koe-nnk).
//!
...
// tool (koe-s7i), session_manager (koe-e3m), and the settings health indicator
// (koe-200), none of which are merged. Allow dead_code module-wide until the
